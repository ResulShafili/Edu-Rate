...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/api/auth/password/reset": { post: { tags:["Authentication"], summary:"E-poçt, birdəfəlik kod və yeni şifrə ilə hesabı bərpa et", responses:{"200":{description:"Şifrə yeniləndi və sessiyalar ləğv edildi"},"422":{description:"Kod etibarsızdır və ya şifrələr uyğun deyil"}} } },
