...
export const mentors: Mentor[] = [
  {
    ...
    bio: "Amina ilkin mərhələdə olan komandalara geniş araşdırmanı insanların asanlıqla anlaya, etibar edə və istifadə edə biləcəyi məqsədyönlü məhsula çevirməyə kömək edir.",
    ...
    outcome: "“Amina dağınıq tezisimi nəhayət inamla izah edə bildiyim aydın məhsul istiqamətinə çevirməyimə kömək etdi.”",
    accent: "#c8ff4d",
  ...
  },
  {
    ...
    bio: "Mateo kodu, səsi, qarşılıqlı əlaqəni və fiziki mühiti birləşdirən prototiplərə sakit və eksperimental yanaşma gətirir.",
    ...
    outcome: "“Mateo ilə bir düşünülmüş görüş prototipimizdə həftələrdir tapa bilmədiyimiz qarşılıqlı əlaqəni üzə çıxardı.”",
    accent: "#ff9e7a",
  ...
  },
  {
    ...
    bio: "Priya ağıllı sistemləri real həyatda daha anlaşılan, ədalətli və faydalı etmək istəyən tədqiqatçı və yaradıcıları dəstəkləyir.",
    ...
    outcome: "“Priya ideyanın gücünü azaltmadan fərziyyələrimi sorğuladı və qürurla müdafiə edə biləcəyim araşdırma hazırlamağıma kömək etdi.”",
    accent: "#b9a7ff",
  ...
  },
  {
    ...
    bio: "Kwame sosial təsir yaradan komandalara problemin altındakı əlaqələri görməyə və hərəkətə təkan verəcək ən kiçik müdaxiləni tapmağa kömək edir.",
    location: "Akra, Qana",
    timezone: "UTC",
    ...
    outcome: "“Kwame komandamıza problem haqqında ortaq dil və elə ertəsi səhər ata biləcəyimiz praktik ilk addım verdi.”",
    accent: "#7de5d1",
  ...
  },
  {
    ...
    bio: "Yuki dizaynerlərə xidmətləri ardıcıl, qayğıkeş və yenidən istifadə etmək üçün həqiqətən rahat edən görünməz detalları anlamaqda bələdçilik edir.",
    ...
    outcome: "“Yuki başqalarının gözdən qaçırdığı üç kiçik məqamı gördü; onları düzəltmək bütün təcrübəni dəyişdi.”",
    accent: "#77b8ff",
  ...
  },
  {
    ...
    bio: "Sofía müstəqil yaradıcı mütəxəssislərə dəyərlərini aydın ifadə etməyə, imkanları məqsədli seçməyə və iddialı işlərini davamlı ritmlə qurmağa kömək edir.",
    ...
    outcome: "“Sofía mənə layihələri sadalamağı dayandırıb çevrildiyim peşəkarın hekayəsini danışmağa başlamaqda kömək etdi.”",
    accent: "#f7d56f",
